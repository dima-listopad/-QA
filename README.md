...
Веб-сервисы, веб-службы – это веб ориентированная технология которая помогает программам общаться между собой использую форматы XML и JSON, посредством протокола SOAP и архитектурного стиля REST.
...
Разница: HTML заботится об отображении информации, а XML о транспортировке информации.
